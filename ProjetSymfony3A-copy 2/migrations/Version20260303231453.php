 ...
 */
final class Version20260303231453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE total_questions total_questions INT DEFAULT 0 NOT NULL, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE wallet CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quiz CHANGE id id INT NOT NULL, CHANGE total_questions total_questions INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE wallet CHANGE id id INT NOT NULL');
    }
}
